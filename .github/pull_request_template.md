...
- [ ] I have tested these changes against a live Sphinx docs site (or with mock data).
- [ ] Public API changes (tool names, parameters, return shapes) are intentional and documented.
